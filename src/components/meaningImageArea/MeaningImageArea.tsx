...
function ImageArea(props: Props) {
  ...
  return (
    <div className="imgs-outer-wrapper">
      <a id="pixabay-link" href="https://pixabay.com/" target="_blank">
        <img
          id="img-pixabay-logo"
          src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Pixabay-logo.svg/1280px-Pixabay-logo.svg.png"
          alt="go to pixabay.com"
        />
      </a>

      <div onWheel={(e) => horizontalScroll(e)} className="images-w">
        <>
          {props.loadingImages ? (
            <div className="images-loading">LOADING ...</div>
